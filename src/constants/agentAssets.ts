...
export const AGENT_VISUALS: Record<AgentAssetId, AgentVisual> = {
  ...
  sight_route: {
    ...
    circleBg: '#DCECFF',
    palette: '折叠导览图、棕色虚线路径、红/橙/蓝多站点',
    motif: '有序路线：虚线路径连接多个站点（不是地标故事）',
  },
  ...
  hotel_guide: {
    ...
    circleBg: '#F5E6D8',
    palette: '2–3 层酒店楼、素色门廊雨棚、行李车+铜铃+房卡；禁红白条纹店招',
    motif: '多层酒店楼体 + 门廊，一眼是酒店不是店铺',
  },
  flight_info: {
    id: 'flight_info',
    label: '航班助手',
  ...
  local_guide: {
    ...
    circleBg: '#DFF5E8',
    palette: '暖石色地标塔/碑、奶油小册或语气泡；禁折地图与多站点',
    motif: '地标 + 讲故事（语气泡/导览册），不是路线图',
  },
